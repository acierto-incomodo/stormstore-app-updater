...
Esta actualización introduce arreglos mayores en el sistema de ajustes y el apartado de "Primer Inicio".
En la actualización también se actualizan los componentes de extraccion de archivos ".zip".
